...
struct division
{
	...
	double cents;  // Cent Amount for Gross Sales
};
...
void getSales(string, int&, double&);
...
// Define the function;
void getSales(string name, int &dollar, double &cents) // This function asks the user for the division's quarterly sales figure
{
	double amount;
	double temp;
	double tempdollar;
